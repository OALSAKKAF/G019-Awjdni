<%@ Page Title="" Language="C#" MasterPageFile="~/hajj/CP/MasterPageCP.master" AutoEventWireup="true" CodeFile="AddUsers.aspx.cs" Inherits="CP_AddUsers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container">
        <div class="box2">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="box4">إضافة مستخدمين</div>
                    <div class="row">
                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" Display="Dynamic" style="font-weight:700" runat="server" ControlToValidate="TbUsername" ForeColor="Red" ValidationGroup="vg1" ErrorMessage="هذا الحقل مطلوب"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" ForeColor="Red" ValidationExpression="[A-Za-z]{5,14}" runat="server" ControlToValidate="TbUsername" ValidationGroup="vg1" ErrorMessage="الرجاء ادخال اسم صالح للاستخدام"></asp:RegularExpressionValidator>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" Display="Dynamic" style="font-weight:700" runat="server" ControlToValidate="TbPassword" ForeColor="Red" ValidationGroup="vg1" ErrorMessage="هذا الحقل مطلوب"></asp:RequiredFieldValidator>
                            ...
                            <div class="form-group">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" Display="Dynamic" style="font-weight:700" ControlToValidate="TbFullNAME" runat="server" ValidationGroup="vg1" ForeColor="Red" ErrorMessage="هذا حقل مطلوب"></asp:RequiredFieldValidator>
                            </div>
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="TbType" CssClass="form-control center-block text-center" runat="server" AutoPostBack="true" OnSelectedIndexChanged="OnSelectedIndexChanged">
                                   ...
                                   <asp:ListItem Value="2">مكتب شؤون الحاج</asp:ListItem>
                            ...
                            <div class="form-group">
                        <asp:Label ID="lblOffice" runat="server" Visible="false" Text="" CssClass="control-label">المكتب</asp:Label>
                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="form-group">
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ForeColor="Red" ControlToValidate="TbEmail" ValidationExpression="^([\w\.\-]+)@([\w\-]+)((\.(\w){2,3})+)$" ValidationGroup="vg1" runat="server" ErrorMessage="ألرجاء ادخال الايميل بشكل صحيح"></asp:RegularExpressionValidator>

                            </div>
                            <div class="form-group">
                                <label for="TbMobile" class="control-label">رقم الجوال</label>
                                <asp:TextBox ID="TbMobile" runat="server" CssClass="form-control  text-center" Width="100%" placeholder="رقم الجوال"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" Display="Dynamic" style="font-weight:700" runat="server" ControlToValidate="TbMobile" ForeColor="Red" ValidationGroup="vg1" ErrorMessage="هذا الحقل مطلوب"></asp:RequiredFieldValidator>
                            </div>
                            <div class="form-group">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" InitialValue="00" Display="Dynamic" style="font-weight:700" runat="server" ValidationGroup="vg1" ForeColor="Red" ControlToValidate="TbActive" ErrorMessage="الرجاء اختيار خاصية التفعيل"></asp:RequiredFieldValidator>
                            </div>
                            <div class="form-group">
                        <label for="Tbtxtuser" class="control-label">الملاحظة</label>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" Display="Dynamic" style="font-weight:700" runat="server" ValidationGroup="vg1" ForeColor="Red" ControlToValidate="Tbtxtuser" ErrorMessage="الرجاء ادخل الملاحظة"></asp:RequiredFieldValidator>
                    ...
                    <div class="form-group">
                        <asp:Button ID="BtnAddUser" runat="server" ValidationGroup="vg1" CssClass="btn btn-primary center-block" Text="حفظ البيانات" OnClick="BtnAddUser_Click" />
                    </div>
                </div>
            </div>
