<%@ Page Title="" Language="C#" MasterPageFile="~/hajj/CP/MasterPageCP.master" AutoEventWireup="true" CodeFile="EditOffice.aspx.cs" Inherits="CP_EditOffice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container">
        <div class="box2">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="box4">تعديل بيانات مكاتب الطوافة</div>
                    <div class="row">
                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="TbAddress" runat="server" CssClass="form-control text-center" Width="100%" placeholder="ادخل عنوان المكتب"></asp:TextBox>
                                  <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" Display="Dynamic" style="font-weight:700" ControlToValidate="TbAddress" ForeColor="Red" ValidationGroup="vg1" ErrorMessage="هذا الحقل مطلوب"></asp:RequiredFieldValidator>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" Display="Dynamic" style="font-weight:700" runat="server" ControlToValidate="TbMobile" ForeColor="Red" ValidationGroup="vg1" ErrorMessage="هذا الحقل مطلوب"></asp:RequiredFieldValidator>
